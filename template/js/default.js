(function($){
    $(function(){
        $('body').on('click', '.kb-add-to-cart:not(.not-available)', function(){
            var $this = $(this);
            ...
            $.ajax({
               ...
               if (undefined !== data['msg']) {
                   if (undefined !== $this.popover && typeof $this.popover === 'function') {
                        $this.popover(
                             {
                                 'title' : data['title'],
                        ...
                        ///$this.find('.glyphicon').html('X').removeAttr('class');
                        $this.parent().find('.popover-title').remove();
                   } else {
                       alert(data['msg']);
                   }
               } else {
